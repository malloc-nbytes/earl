...
*NOTE*: *This language is currently being rewritten to be a bytecode interpreter. See branch `rewrite` for updates.*
...
*NOTE*: (If contributing) do not modify the =README.html= as it is auto generated from =README.org= by [[https://orgmode.org/][Emacs Org Mode]].
...
For the manual on how to use the language, see [[https://malloc-nbytes.github.io/EARL-web/][Click here for the EARL Language Reference]].
...
=earlmgr= is a script similar to Python's =pip= and can be downloaded [[https://github.com/malloc-nbytes/earlmgr][here]].

*Note*: =earlmgr= is a WIP. USE AT YOUR OWN RISK!
...
[[https://malloc-nbytes.github.io/EARL-web/][Click here for the EARL Language Reference]]
